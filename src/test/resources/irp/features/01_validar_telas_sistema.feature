...
Feature: Validar telas do sistema
  ...
  Scenario: Validar o menu Histórico de Faturas
  	Given que acessei a classe "HistoricoDeFaturas"
  	When valido o texto "Filtro de faturas"
    And valido o texto "País de Faturamento"
    And valido o texto "Moeda de Faturamento"
    And valido o texto "Serviço"
    And valido o texto "País"
    And valido o texto "Período Inicial"
    And valido o texto "Período Final"
    And valido o texto "Tipo de Filtro"
    And valido o texto "Status"
    Then valido o componente "Botão Listar"	    
    
  Scenario: Validar o menu Admin
  	Given que acessei a classe "TrocaDeSenha"
  	When valido o texto "Trocar Senha"
    And valido o texto "Senha atual"
    And valido o texto "Nova senha"
    And valido o texto "Confirme a senha"
    Then valido o componente "Botão Salvar"	 
    Given que acessei a classe "Resetar2FA"    
    When valido o texto "Se você reiniciar sua chave de autenticação"
    Then valido o componente "Redefinir chave de autenticação"