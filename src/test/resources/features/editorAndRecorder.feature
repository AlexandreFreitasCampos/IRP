...
Funcionalidade: Gerar relatórios
  ...
  Esquema do Cenario: Gerar "<arquivo>"
    ...
    Exemplos:
      ...
      | rel_person_rec_edit_artistas | Gravadora | OTT          | Relatorios Unificados | Artistas |
...
#      | rel_person_recorder_artistas      | Gravadora | OTT          | Relatorios Unificados | Artistas        |
...
##      | rel_person_editor_artistas | Gravadora | OTT          | Relatorios Unificados | Artistas |
