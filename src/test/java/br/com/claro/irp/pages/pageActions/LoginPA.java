...
public class LoginPA extends DriverFactory implements Action {
	...
	public void getURL(String string) {
		try {
			switch (string) {
			case "https://irp.imusica.com.br/Account/Login":
	...
	public void clicarBotao(String string) {
		try {
			...
			case "Log in":
				...
				acoesweb.aguardaElementoPresente(acaoMenu.btnSair);
				salvaDocumento();
				break;
			case "Login":
				acaoLogin.btnLogin.click();
