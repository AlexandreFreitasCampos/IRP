...
public class MenuPA extends DriverFactory implements Action {
	...
	public void clicarBotao(String string) {
		try {
			...
			case "Admin"  :
				...
				break;
			/*case "Troca de senha"  :
				acaoMenu.btnTrocaDeSenha.click();
			...
			case "Registro de Usuários":
				acaoMenu.menuAdmin.click();
				acaoMenu.btnRegistroDeUsuarios.click();
				acoesWeb.aguardaElementoPresente(acao.textoNenhumSelecionado);
				break;		*/
			/*case "Botão Salvar":
				elementoPresente = acaoMenu.btnSalvar.isDisplayed();
				if (elementoPresente) {
